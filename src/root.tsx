...
export const links: Route.LinksFunction = () => [
    ...
    {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Display:ital,wght@0,100..900;1,100..900&family=Tektur:wght@400..900&display=swap',
    },
    {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Noto+Sans+Display:wdth,wght@62.5,100&display=swap',
    },
];
