            ...
            <div className={'_container-default'}>
                ...
                <div className={classes.info}>
                    <p className={classes.paragraph}>
                        Мы разрабатываем ПЛАРН, ПМЛА, Планы ЧС и другие виды
                        технической документации для предприятий и муниципальных
                        образований по всей России. <br /> Компания стабильно
                        развивается и обеспечивает высокий уровень надёжности: у
                    ...
                    <p className={classes.paragraph}>
                        ...
                        также охране труда, что делает документы максимально
