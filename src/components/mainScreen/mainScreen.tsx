        ...
        <div className={classes.mainScreen}>
            <div className={classes.content}>
                ...
                <div className={classes.subtitle}>
                    <Subtitle>
                        <h1>Разработка технической документации по промышленной
                            безопасности и предупреждению чрезвычайных ситуаций.</h1>
                    </Subtitle>
                </div>
                <div
                    ref={ref}
                ...
                >
                    <p>
                        Разработаем и согласуем ПЛАРН, ПМЛА, План КУ, План
                        действий при ЧС.
                    </p>
                    <p>
